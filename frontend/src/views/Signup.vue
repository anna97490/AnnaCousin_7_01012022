<template>
  <div class="body">
    <div class="card">
      ...
      <h1 class="card__title" v-if="mode == 'signup'">
        Votre réseau social d'entreprise!
      </h1>
      <router-link class="card__signup" to="/" width="100%"
        ><strong>Se connecter</strong></router-link
      >
      <form>
        <div class="card__form">
          <input
            class="card__form--input1"
            type="email"
            v-model="email"
            placeholder="Email"
            required
          ...
          <div class="card__form--name">
            <input
              class="card__form--input2"
              type="firstname"
              v-model="firstname"
              placeholder="Prénom"
              required
              aria-label="Prénom pour la connection"
            />
            <input
              class="card__form--input2"
              type="lastname"
              ...
              placeholder="Nom"
              required
              aria-label="Nom pour la connection"
            />
          </div>
          <input
            class="card__form--input1"
